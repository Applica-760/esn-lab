...
uv run -m projects.tasks.cli analysis.margin.output_trajectory
```

## 設定と成果物

- 解析設定: `projects/tasks/analysis/margin/output_trajectory/cfg.yaml`
- 入力: `outputs/experiments/pred_margin_beta_2class/` 配下の各 group・parameter directory の `test_results.npz`
- 出力: `outputs/experiments/analysis_margin_beta_2class_output_trajectory/` 配下の各 parameter directory の `score_trajectory_3x2.png`
