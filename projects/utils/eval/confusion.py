...
def compute_cm_from_judgment_results(judgment_results: list, n_classes: int) -> np.ndarray:
    """
    判定結果リストから混同行列を計算
    """
    y_true = [r["true_label"] for r in judgment_results]
    y_pred = [r["pred_label"] for r in judgment_results]
